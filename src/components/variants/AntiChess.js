  ...
  return (
    <div>
      ...
      <div>
        ...
        <p style={bodyStyle}>
        In antichess, the first player to run out of legal moves (typically by losing all his/her
        pieces) wins.Captures are mandatory whenever a capture is possible (if multiple captures are
        possible, then the player can choose).The third change of rules is that the king is not a
        special piece: it cannot be checked/checkmated, castling is disallowed, and pawns can
        promote to a king.
        </p>
        ...
        <Row className="justify-content-md-center">
          ...
          <Col xs="auto" xl="4" style={{ marginBottom: '2rem' }}>
            <span style={{ fontFamily: 'serif', fontWeight: 'bold' }}>1. a4 ♖xa4#</span>
            <br />
