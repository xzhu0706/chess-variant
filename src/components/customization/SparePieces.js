    ...
    <form onChange={props.handleChange}>
      <div className="piece-selector">
        <div className="non-spares">
          <span className="explanation">hi</span>
        ...
        <div>
          ...
          <label className="piece-card white-joker" htmlFor="white-joker"></label>
          <input id="black-joker" type="radio" name="piece" value="c" />
          <label className="piece-card black-joker" htmlFor="black-joker"></label>
        </div>
      </div>
    </form>
  );
