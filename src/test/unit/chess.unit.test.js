...
describe('attacked() unit testing', () => {
  ...
  + 'when it is blocked by a friendly piece 1 knight distance away', () => {
    const standardGame10 = mychessjs.Chess('rnbqkbnr/pppp4/5Q2/8/6D1/8/PPPPPPPP/RNBQKB1R b KQkq - 0 1', 0);
    // +------------------------+
    // 8 | r  n  b  q  k  b  n  r |
    // 7 | p  p  p  p  .  .  .  . |
    // 6 | .  .  .  .  .  Q  .  . |
  ...
  + 'when it is blocked by a friendly piece 1 knight distance away', () => {
    const standardGame11 = mychessjs.Chess('rnbqkbnr/pppp4/5Q2/8/6S1/8/PPPPPPPP/RNBQKB1R b KQkq - 0 1', 0);
    // +------------------------+
    // 8 | r  n  b  q  k  b  n  r |
    // 7 | p  p  p  p  .  .  .  . |
    // 6 | .  .  .  .  .  Q  .  . |
  ...
  test('In standard chess, a diagonally adjacent ferz attacks the enemy king ', () => {
    const standardGame12 = mychessjs.Chess('rnbqkbnr/pppp1F2/8/8/8/8/PPPPPPPP/RNBQKB1R b KQkq - 0 1', 0);
    // +------------------------+
    // 8 | r  n  b  q  k  b  n  r |
    // 7 | p  p  p  p  .  F  .  . |
    // 6 | .  .  .  .  .  .  .  . |
  ...
  + 'when the diagonal contains no intermediate piece', () => {
    const standardGame13 = mychessjs.Chess('rnbqkbnr/pppp4/8/7S/8/8/PPPPPPPP/RNBQKB1R b KQkq - 0 1', 0);
    // +------------------------+
    // 8 | r  n  b  q  k  b  n  r |
    // 7 | p  p  p  p  .  .  .  . |
    // 6 | .  .  .  .  .  .  .  . |
  ...
  + 'when the diagonal contains an intermediate piece', () => {
    const standardGame14 = mychessjs.Chess('rnbqkbnr/pppp1p2/8/7S/8/8/PPPPPPPP/RNBQKB1R b KQkq - 0 1', 0);
    // +------------------------+
    // 8 | r  n  b  q  k  b  n  r |
    // 7 | p  p  p  p  .  p  .  . |
    // 6 | .  .  .  .  .  .  .  . |
  ...
  + "from the opponent's king is checking the opponent (if there are no interceding pieces)", () => {
    const customPiece = { c: { 0: [], 1: [-32] } };
    const standardGame = mychessjs.Chess('rnbqkbnr/pppppppp/8/8/8/4P3/PPPPCPPP/RNB1KBNR b KQkq - 0 1', 0, customPiece);
    // +------------------------+
    // 8 | r  n  b  q  k  b  n  r |
    // 7 | p  p  p  p  p  p  p  p |
    // 6 | .  .  .  .  .  .  .  . |
  ...
  const antiGame2 = mychessjs.Chess('1k6/8/8/8/8/8/2q5/1K6 w - - 0 1', 0);
  // +------------------------+
  // 8 | .  k  .  .  .  .  .  . |
  // 7 | .  .  .  .  .  .  .  . |
  // 6 | .  .  .  .  .  .  .  . |
